      ...
      <div className="absolute inset-4 md:inset-8 pointer-events-none">
        ...
        >
          ...
          <g opacity="0.4">
            {/* Top Left */}
            <path
              d="M0 0 Q100 0, 150 50 Q170 75, 180 100"
              stroke="#D4A84B"
              strokeWidth="3"
              fill="none"
            />
            <path
              d="M0 0 Q80 0, 130 45 Q150 65, 160 90"
              stroke="#5C4033"
              strokeWidth="2"
              fill="none"
            />
            ...
            {/* Top Right */}
            <path
              d="M1200 0 Q1100 0, 1050 50 Q1030 75, 1020 100"
              stroke="#D4A84B"
              strokeWidth="3"
              fill="none"
            />
            <path
              d="M1200 0 Q1120 0, 1070 45 Q1050 65, 1040 90"
              stroke="#5C4033"
              strokeWidth="2"
              fill="none"
            />
            ...
            {/* Bottom Left */}
            <path
              d="M0 800 Q100 800, 150 750 Q170 725, 180 700"
              stroke="#D4A84B"
              strokeWidth="3"
              fill="none"
            />
            <path
              d="M0 800 Q80 800, 130 755 Q150 735, 160 710"
              stroke="#5C4033"
              strokeWidth="2"
              fill="none"
            />
            ...
            {/* Bottom Right */}
            <path
              d="M1200 800 Q1100 800, 1050 750 Q1030 725, 1020 700"
              stroke="#D4A84B"
              strokeWidth="3"
              fill="none"
            />
            <path
              d="M1200 800 Q1120 800, 1070 755 Q1050 735, 1040 710"
              stroke="#5C4033"
              strokeWidth="2"
              fill="none"
            />
      ...
      <div className="container h-full flex flex-col justify-center items-center gap-6 relative z-10 text-center">
        <div className="bg-gradient-to-br from-[#5C4033]/80 to-[#3C2A20]/90 backdrop-blur-sm rounded-[20px] py-[20px] px-[30px] border border-[#D4A84B]/30 shadow-2xl">
          ...
          <p className="text-[#E8DCC8] max-w-[800px] font-museo text-lg md:text-xl mb-4 font-medium">
            Festival jamu terbesar di Indonesia
            <br />
            yang menyatukan tradisi dan generasi masa kini.
          </p>
          <h1
            className="text-white max-w-[800px] font-display text-4xl md:text-6xl mb-4 tracking-widest"
