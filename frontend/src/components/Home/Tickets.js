    ...
    return (
        <section id="tiket" className="tickets-section">
            <div className="container flex flex-col md:flex-row justify-between">
                <div>
                    <h2 className="text-white">{festival.ticket_title}</h2>
                    <p className="text-white text-[20px]/[normal]">{festival.ticket_lead}</p>
                    <div className="period">
                        <strong>Periode Penjualan Tiket</strong>
                        <span>{festival.sales_period}</span>
                    </div>
                </div>
                <div className="tickets">
                    {festival?.tickets && festival.tickets.map((ticket, index) => (
                        <div className="ticket" key={index}>
                            ...
                            <div className="description">{ticket.subtitle}</div>
